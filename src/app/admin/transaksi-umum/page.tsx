...
export default function TransaksiUmumPage() {
  ...
  let umumTransactions = transactions.filter(t => {
    ...
    if (t.id.startsWith("MTS-") && (t.mutasiDari === "kas_umum" || t.mutasiKe === "kas_umum")) {
      if (t.mutasiStatus === 'rejected' && t.mutasiKe === "kas_umum") return false;
      return true;
    }
    return false;
  }).map(t => {
                  ...
                  <tr key={t.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-2">
                        {t.isMutasi && t.mutasiStatus === 'pending' && t.mutasiKe === "kas_umum" ? (
                           <>
